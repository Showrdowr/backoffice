...
export function DeleteQuestionModal({ isOpen, onClose, onConfirm, question }: DeleteQuestionModalProps) {
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-fade-in">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md animate-slide-in">
                <div className="p-6 bg-gradient-to-r from-red-500 to-pink-500 text-white rounded-t-2xl">
                    <h3 className="text-2xl font-bold">ยืนยันการลบคำถาม</h3>
                </div>
                <div className="p-6">
                    ...
                    <p className="text-center font-semibold text-slate-800 mb-4 line-clamp-2">
                        "{question.question}"
                    </p>
